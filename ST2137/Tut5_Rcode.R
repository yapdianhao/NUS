...
## IMPORTANT NOTE:
# When conducting a test like Chi-square test, there are some steps 
# that you should follow:
# Step 1: check the assumption, to know which test is suitable to conduct
# Step 2: state hypotheses
# Step 3: derive test statistic (eith manual or by software)
# Step 4: report p-value
# Step 5: draw conclusion

# The answers of the questions given below, detail of every step above 
# is somehow skipped for quick answer. 
# However, you SHOULD NOT skip the details in your answer.
